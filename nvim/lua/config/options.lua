local options = {
    ...
    shiftwidth = 4,    -- indentation width for auto-indent
    softtabstop = 4,   -- spaces when pressing <Tab>

    autoindent = true,  -- carry over indentation from previous line
    smartindent = true, -- C-like smart indent
    cindent = false,    -- disable C-style auto-indent if you want simpler behavior
    smarttab = true,    -- <Tab> uses shiftwidth spaces
